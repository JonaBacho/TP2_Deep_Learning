...
class MLflowConfig:
    ...
    MODEL_NAME = os.getenv("MODEL_NAME", "mnist-improved-classifier")
    
    # Seuils de promotion automatique
    MIN_ACCURACY = float(os.getenv("MIN_ACCURACY", "0.98"))
    MIN_F1_SCORE = float(os.getenv("MIN_F1_SCORE", "0.98"))
    MAX_LOSS_GAP = float(os.getenv("MAX_LOSS_GAP", "0.05"))
